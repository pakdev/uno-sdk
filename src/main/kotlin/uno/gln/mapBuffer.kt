...
//fun glMapBufferRange(target: Int, length: Long, access: Int): ByteBuffer = GLES20.glMapBufferRange(target, 0, length.L, access)
...
//
//fun ByteBuffer.map(target: Int, access: Int) = GLES20.glMapBuffer(target, access, this)
